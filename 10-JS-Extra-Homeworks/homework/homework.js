...
function numberOfCharacters(string) {
  //La función recibe un string. Recorre el srting y devuelve el caracter con el número de veces 
  //que aparece 
...
function asAmirror(str) {
  ...
  //Escribe tu código aquí
  let array = str.split(' ').map(function (elemento){
...
function capicua(numero){
  ...
  let array = numstring.split("").reverse().join("");
    if (array === numstring) {
      return "Es capicua" 
...
function deleteAbc(cadena){
 ...
 // array.forEach(function(eliminar){
